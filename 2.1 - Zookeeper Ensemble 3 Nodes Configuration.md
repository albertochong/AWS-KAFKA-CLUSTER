...
**server.1=zookeeper1:2888:3888** | Node 1.these hostnames from the /etc/hosts file and port comunication between zookerpers and port election
**server.2=zookeeper2:2888:3888** | Node 2.these hostnames from the /etc/hosts file and port comunication between zookerpers and port election
**server.3=zookeeper3:2888:3888** | Node 3.these hostnames from the /etc/hosts file and port comunication between zookerpers and port election
